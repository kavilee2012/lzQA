<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Role2User.aspx.cs" Inherits="SystemUI_UserUI_Role2User" %>
   ...
   <div>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            ...
            SelectMethod="GetRole2User" TypeName="BLL.UserBLL">
                        <SelectParameters>
                            <asp:QueryStringParameter Name="userID" QueryStringField="code" Type="String" />
                        </SelectParameters>
        </asp:ObjectDataSource>
                <br />
        <br />
